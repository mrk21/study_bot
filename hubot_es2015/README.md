...
hubot-es2015 is a chat bot built on the [Hubot][hubot] framework. It was
...
### Running hubot-es2015 Locally

You can test your hubot by running the following, however some plugins will not
behave as expected unless the [environment variables](#configuration) they rely
upon have been set.

You can start hubot-es2015 locally by running:
...
Then you can interact with hubot-es2015 by typing `hubot-es2015 help`.

    hubot-es2015> hubot-es2015 help
    hubot-es2015 animate me <query> - The same thing as `image me`, except adds [snip]
    hubot-es2015 help - Displays all of the help commands that hubot-es2015 knows about.
    ...
...
1. Install `direnv`
1. Enter `hubot` command
2. Enter `hubot-test hello` command on console
3. If the hubot returns `world` response, it succeed!

### Slack

1. Enter `hubot -a slack` command
